...
* Fix - Wrong price calculation in cart for variable products.
...
* Fix - Plugin textdomain loaded too early.
* Tweak - Updated date functions using PHP DateTime class.
* Tweak - Updated demo link in readme.txt.
